...
ggarrange(p7,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggexport(filename = "r1_SMSE_for_MLE_MI_LR_TV_Exp_mMSE.pdf",res=300,width = 12,height = 12)
ggarrange(p8,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggexport(filename = "r1_SMSE_for_MLE_MI_LR_TV_Exp_mVc.pdf",res=300,width = 12,height = 12)
...
ggarrange(p7,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggexport(filename = "r1_SMSE_for_MLE_MI_LR_TV_Exp_mMSE.eps",res=300,width = 12,height = 12)
ggarrange(p8,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggexport(filename = "r1_SMSE_for_MLE_MI_LR_TV_Exp_mVc.eps",res=300,width = 12,height = 12)
```