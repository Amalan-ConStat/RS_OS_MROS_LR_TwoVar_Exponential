...
{
  theme(axis.text.x = element_text(color = "black",size=18, angle = 45, hjust=0.75), #, vjust = 0.5
        axis.text.y = element_text(color = "black",size=18), #, vjust = 0.5, hjust=1
        ...
        #legend.box.margin=margin(1,3,1,3)
...
ggarrange(p3,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggsave(filename = "Poster_SMSE_LR_TV_Exp_mMSE.eps",device="eps",dpi=300,width = 14,height = 10)
